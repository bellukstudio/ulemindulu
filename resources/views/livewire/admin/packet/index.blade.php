<div>
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg w-full p-6 mt-16">
            ...
            <div class="grid md:grid-cols-2 gap-5 p-3">
                ...
                <div class="relative w-full">
                    ...
                    <input type="text" id="table-search" wire:model.live.debounce.500ms="search"
                        ...
                        placeholder="Search for packet name, feature..." />
                </div>
        ...
        <x-ui.table :headers="['#', 'Packet Name', 'Feature', 'Price', 'Discount', 'Action']">
            @forelse ($packets as $index => $packet)
                <tr class="border-b hover:bg-gray-100 dark:hover:bg-gray-600">
                    ...
                    <td class="px-6 py-3">
                        <div class="max-w-xs truncate" title="{{ $packet->feature }}">
                            {{ Str::limit($packet->feature, 50) }}
                        </div>
                    </td>
                    ...
                    <td class="px-6 py-3">
                        <div class="flex space-x-2">
                            ...
                            <button wire:click="delete('{{ $packet->id }}')"
                                wire:confirm="Are you sure you want to delete this packet?"
        ...
        @if ($packets->hasPages())
            <div class="mt-4">
                {{ $packets->links('pagination::tailwind') }}
            </div>
        @endif

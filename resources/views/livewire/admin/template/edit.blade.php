        ...
        <form wire:submit.prevent="update" class="w-full">
            ...
            <div class="mb-4">
                <label for="thumbnail" class="block text-sm font-medium text-gray-700 mb-2">
                    {{ $currentThumbnail ? 'Upload New Thumbnail (Optional)' : 'Upload Thumbnail' }}
                </label>
                ...
                @if ($uploadedUrl)
                    <div class="mt-4 p-4 bg-green-50 rounded-lg border border-green-200">
                        <div class="flex items-center justify-between mb-2">
                            <label class="text-sm font-medium text-green-800">New Thumbnail Preview</label>
                            <button type="button" wire:click="removeThumbnail"
                                class="text-red-500 hover:text-red-700 text-sm font-medium">
                                × Remove
                            </button>
                        </div>
                        <img src="{{ $uploadedUrl }}" alt="New thumbnail preview"
                            class="w-32 h-32 object-cover rounded-lg border shadow-sm">
                        <p class="text-xs text-green-600 mt-2">This image will replace the current thumbnail when you
                            save.</p>
                    </div>
                @endif
            ...
            <div class="flex justify-end space-x-4">
                ...
                <button type="submit"
                    ...
                    <span wire:loading wire:target="update" class="inline-flex items-center justify-center">

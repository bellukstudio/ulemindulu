            ...
            <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 z-10 relative">
                ...
                >
                    ...
                    <span className="text-sm font-medium">
                        Fitur baru diluncurkan! Coba template undangan terkini
                    </span>
                    <svg
                ...
                <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">
                    Buat Undangan Digital Praktis & Elegan di{" "}
                    <span className="text-blue-600">Ulemindulu</span>
                </h1>

                <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-200">
                    Ulemindulu adalah solusi undangan online untuk acara
                    pernikahan, ulang tahun, syukuran, dan lainnya. Pilih
                    template, isi data, dan bagikan dengan mudah — cepat, hemat,
                    dan modern.
                </p>
